...
namespace MetarParserCoreTests.Taf
{
    ...
    {
        [Fact]
        public void ParseTafExampleUwkd_Successful()
        {
        ...
        [Fact]
        public void ParseTafExampleKjfk_Successful()
        {
            var rawString = "TAF AMD KJFK 081859Z 0819/0924 28013G21KT P6SM SCT070 BKN250" +
                            "\r\nFM090000 29010KT P6SM FEW060" +
                            "\r\nFM090400 34006KT P6SM SCT250" +
                            "\r\nFM091200 04008KT P6SM BKN100" +
                            "\r\nFM091500 11007KT P6SM OVC100" +
                            "\r\nFM092100 17008KT P6SM BKN250";
            var tafParser = new TafParser();
            var airportTaf = tafParser.Parse(rawString);
